...
<div id="app">
    <aside>
        ...
        <fieldset>
            ...
            <span class="select">
                <select name="chapter" id="chapter" onchange="handleChanges()">
