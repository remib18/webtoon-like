...
$userName = UserController::getById($_SESSION['id'])->getUsername();
...
<div id="app">
    ...
    <form action="/@proposition?BlockId=<?= $_GET['BlockId'] ?>&TranslationId=<?= $_GET['TranslationId'] ?>"
        ...
        <div class="grid-container">
            ...
            <textarea class="large-1" name="proposition" id="proposition" cols="100"
                      rows="10"><?= trim(PropositionManager:: getContent())/*Affiche le résultat pour réécrire par-dessus*/ ?></textarea>
