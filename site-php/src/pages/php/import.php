...
<div aria-describedby="#s1-title" id="app">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="976" height="100" viewBox="0 0 976 130" fill="none" id="completion">
        ...
        <mask id="mask0_139_252" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="976"
              height="100">
            ...
            <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M756.753 55C756.916 53.3555 757 51.6875 757 50C757 48.3125 756.916 46.6445 756.753 45H971C973.761 45 976 47.2386 976 50C976 52.7614 973.761 55 971 55H756.753ZM657.247 55H318.753C318.916 53.3555 319 51.6875 319 50C319 48.3125 318.916 46.6445 318.753 45H657.247C657.084 46.6445 657 48.3125 657 50C657 51.6875 657.084 53.3555 657.247 55ZM5 45H219.247C219.084 46.6445 219 48.3125 219 50C219 51.6875 219.084 53.3555 219.247 55H5.00001C2.23858 55 0 52.7614 0 50C0 47.2386 2.23858 45 5 45Z"
                  fill="#656D6D"/>
        </mask>
