...
const PAGES = [
    ...
    '@api/translations-blocks' => ['accessLevel' => AccessLevel::everyone],
    '@api/webtoons'            => ['accessLevel' => AccessLevel::everyone],
    'login'                    => ['accessLevel' => AccessLevel::everyone],
    'register'                 => ['accessLevel' => AccessLevel::everyone]
];
...
const NAVIGATION = [
    ...
    'actions' => [
        ...
        'label'       => 'Utilisateur',
        'tooltip'     => 'Accéder aux options utilisateur',
        'accessLevel' => AccessLevel::authenticated
    ],
];
